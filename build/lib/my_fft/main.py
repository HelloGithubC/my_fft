...
class FFTPowerCPP:
    ...
    def runPS3D(self, field, nthreads=1):
        self.fft.RunPS3D(field, nthreads)
        self.is_run_ps_3d = True
    ...
    def run(
        ...
        if self.is_run_ps_3d and run_ps_3d:
            print("Warning: run_ps_3d is force set to False because you have run runPS3D before")
            run_ps_3d = False
        if not self.is_run_ps_3d and not run_ps_3d:
            print("Warning: You do not call runPS3D and run_ps_3d is set to False. If you call other function to do that, you can use .is_run_ps_3d = True to remove this warning.")
        ...
        if run_ps_3d:
            self.fft.RunPS3D(
                field_complex, nthreads
            )
            self.is_run_ps_3d = True
        self.fft.RunFFTPower(
            power,
            power_mu,
            power_k,
            power_modes,
